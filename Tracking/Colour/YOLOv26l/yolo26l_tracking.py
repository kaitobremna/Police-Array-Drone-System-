...
model = YOLO("/Users/kaitobremner/Desktop/Studies/Y3/3YP/Drone_software/Police-Array-Drone-System-/Object_detection/Aerial image optimisation/YOLOv26l/yolo26l.pt")
# 2. Define path to your custom images !!CHANGE THIS!!
# Can be a single image, a folder, or even a video file
source_path = "/Users/kaitobremner/Desktop/Studies/Y3/3YP/Drone_software/Police-Array-Drone-System-/datasets/VisDrone2019-MOT-test-dev/sequences/uav0000073_00600_v"
tracker_path = "/Users/kaitobremner/Desktop/Studies/Y3/3YP/Drone_software/Police-Array-Drone-System-/Tracking/Colour/YOLOv26l/YOLOv26l_tracker.yaml"

# Output directory
output_dir = "runs/YOLO26l_tracks/uav0000073_00600_v"
...
results = model.track(
    ...
    conf=0.242,                     # Confidence threshold (adjust if it misses things)
    # imgsz=640,                   # Processing resolution
    iou=0.5,                      # IoU threshold for tracking
    project="/Users/kaitobremner/Desktop/Studies/Y3/3YP/Drone_software/Police-Array-Drone-System-/runs/YOLO26l_tracks",
    name="uav0000073_00600_v",
    exist_ok=True
)
